...
begin
  ...
  AssertEquals('Wrong Type of ControlManager',(DUT is TPSECControlManager), True);
  { TODO -oaf : SecureManger not initilised at start up now}
  // Check if the SecureManager is well initialized
  //AssertNotNull('SecureManager should not initialized',DUT.SecureManager);
